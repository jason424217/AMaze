...
import yuanguandziyuezhou.cs301.cs.wm.edu.amazebyyuanguandziyuezhou.generation.BSPBranch;
import yuanguandziyuezhou.cs301.cs.wm.edu.amazebyyuanguandziyuezhou.generation.BSPLeaf;
...
import yuanguandziyuezhou.cs301.cs.wm.edu.amazebyyuanguandziyuezhou.generation.Seg;
...
public class FirstPersonDrawer {
    ...
    public FirstPersonDrawer(int width, int height, int mapUnit, int stepSize, Cells seenCells, BSPNode bspRoot) {
        ...
        Log.v("FirstPersonDrawer", "screen drawn");
    ...
    private void drawSegment(Seg seg) {
        ...
        mp.setcolor(color[0], color[1], color[2], true);
