...
public class MapDrawer {
     ...
     * @param mp graphics handler to manipulate screen
    ...
    private void drawCurrentLocation(MazePanel mp, int viewDX, int viewDY) {
        ...
        mp.filloval(centerX, centerY, diameter, diameter);
