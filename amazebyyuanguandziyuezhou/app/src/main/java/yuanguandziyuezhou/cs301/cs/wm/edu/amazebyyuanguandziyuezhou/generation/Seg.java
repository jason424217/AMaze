...
import yuanguandziyuezhou.cs301.cs.wm.edu.amazebyyuanguandziyuezhou.gui.MazePanel;
...
public class Seg {
    ...
    private void initColor(final int distance, final int cc) {
        ...
        switch (((d >> 3) ^ cc) % 6) {
            case 0:
                col = new int[] {rgbValue, RGB_DEF, RGB_DEF};
                setColor(col);
                break;
            case 1:
                col = new int[] {RGB_DEF, rgbValue, RGB_DEF};
                setColor(col);
                break;
            case 2:
                col = new int[] {RGB_DEF, RGB_DEF, rgbValue};
                setColor(col);
                break;
            case 3:
                col = new int[] {rgbValue, rgbValue, RGB_DEF};
                setColor(col);
                break;
            case 4:
                col = new int[] {RGB_DEF, rgbValue, rgbValue};
                setColor(col);
                break;
            case 5:
                col = new int[] {rgbValue, RGB_DEF, rgbValue};
                setColor(col);
                break;
            default:
                col = new int[] {RGB_DEF, RGB_DEF, RGB_DEF};
                setColor(col);
                break;
        }
    }
    ...
    public boolean equals(final Object other) {
        ...
        if ((dist != o.dist) || (partition != o.partition) || (seen != o.seen)
                || (MazePanel.getRGB(getColor()) != MazePanel.getRGB(o.getColor()))) {
            return false;
        }
    ...
    /**
     * @param col color rgb value array
     *            the color to set
     */
